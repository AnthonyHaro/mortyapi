...
import { SaveService } from '../services/save.service'; // Asegúrate de que la ruta sea correcta

@Component({
  selector: 'app-morty-details',
  standalone: true,
  imports: [CommonModule, IonicModule, FormsModule],
  templateUrl: './morty.page.html',
  styleUrls: ['./morty.page.scss'],
})
export class MortyDetailsPage implements OnInit {
  id = '';
  details: any = null;
  comment: string = '';
  savedComment: string = '';
